...
// CORRECTION 1 : .strict() sur les deux schémas — anti-mass assignment
// CORRECTION 2 : limites max sur les champs texte
// CORRECTION 3 : dateDebut doit être dans le futur ou présent
//                un étudiant ne peut pas créer un stage avec une date passée
